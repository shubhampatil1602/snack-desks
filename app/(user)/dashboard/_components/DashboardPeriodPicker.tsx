...
export function DashboardPeriodPicker({ period, userJoinedAt }: Props) {
  const router = useRouter();
  const searchParams = useSearchParams();

  // Generate months from user join date to now
  const months = generateMonthsFromDate(userJoinedAt);
